...
class ShapeNetIO:
    ...
    def __init__(self, BASE_DIR='/vision01/pointnet/part_seg/', batchsize=24):
        ...
        #print('h5_base_path-',self.h5_base_path)
    ...
    def LoadTrainValFiles(self):
        ...
        print('len(train_data)------',self.train_data.shape)
        print('len(train_labels)------',self.train_labels.shape)
        print('len(train_seg)------',self.train_seg.shape)
        print('len(train_data_idx)------',self.train_data_idx.shape)
        ...
        print('len(val_data)------',self.val_data.shape)
        print('len(val_labels)------',self.val_labels.shape)
        print('len(val_seg)------',self.val_seg.shape)
        print('len(val_data_idx)------',self.val_data_idx.shape)
    ...
    def NextBatch_TrainSet(self,shuffle_flag=False):
        ...
        #print('self.train_samp_ptr',self.train_samp_ptr)
